  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="mobile">
        ...
        <el-input ref="username" v-model="loginForm.mobile" placeholder="请输入手机号" name="username" type="text" tabindex="1"
          auto-complete="on" />
      </el-form-item>
      ...
      <div class="tips">
        <span style="margin-right:20px;">账号: 黄伟是宇宙最强程序员</span>
        <span> 密码:可惜黄伟没头发</span>
      </div>
